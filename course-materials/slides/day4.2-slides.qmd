...
- In two water samples, exceeding the nitrate limit in one (one event) and exceeding nitrate limit in another (second event)
...
Exceeding the nitrate limit in two separate water samples could be non-independent. Perhaps both samples are affected by the same upstream agricultural runoff, so if $A$ occurs, $B$ becomes more likely too. We need more information to assess this!
...
- $A \cap B$ = nitrate concentration exceeds the safety limit both upstream *and* downstream of the farm

- $A \cup B$ = nitrate concentration exceeds the safety limit upstream, downstream, or both

- $A'$ = nitrate concentration does *not* exceed the safety limit upstream
...
|---|---|---|---|
| **Population** | All nitrate concentration readings in the stream over the year | All registered voters in Santa Barbara County | All purple urchins in the Channel Islands Marine Sanctuary |
