...
✏️ [For each of the scenarios, identify which are the dependent and independent variables, what type of variable is each one of them (quant/qual/binary/nominal/ordinal/discerete/continuous).]{style="color:green;"}
...
<div class="page-center">
<div class="custom-subtitle">Basic data visualizations</div>
</div>
...
## {#scatterplots-blank data-menu-title="Scatterplots"}
...
## {#histogram-blank data-menu-title="Histogram"}
...
ggplot(data.frame(dbh), aes(x = dbh)) +
  geom_histogram(breaks = seq(5, 30, by = 5), closed = "left", color = "white") +
...
ggplot(data.frame(waves), aes(x = waves)) +
  geom_histogram(breaks = seq(0, 4, by = 1), closed = "left", color = "white") +
...
## {#quartiles-blank data-menu-title="Quartiles"}
...
✏️ [Find $Q_1, Q_2,$ and $Q_3$ for the values 4, 16, 8, 40, 2, 14, 6, 10, 12]{style="color:green;"}

::: {.notes}
Ordered: 2, 4, 6, 8, 10, 12, 14, 16, 40
Median (Q2) = 10
Lower half: 2, 4, 6, 8 (four values) → Q1 = (4+6)/2 = 5
Upper half: 12, 14, 16, 40 (four values) → Q3 = (14+16)/2 = 15
:::

---

## {#quartiles-example data-menu-title="Quartiles"}

[Quartiles: solution]{.slide-title}
...
[Find $Q_1, Q_2,$ and $Q_3$ for the values 4, 16, 8, 40, 2, 14, 6, 10, 12]{style="color:green;"}
...
## {#boxplot1 data-menu-title="Boxplot 1" .smaller}
...
## {#boxplot-draw-blank data-menu-title="Exercise: draw a box plot"}

[Exercise: draw a box plot]{.slide-title}
...
✏️ [Using the quartiles you just found for 2, 4, 6, 8, 10, 12, 14, 16, 40 ($Q_1=5$, $Q_2=10$, $Q_3=15$), draw the box plot by hand.]{style="color:green;"}

---

## {#boxplot-draw-work data-menu-title="Exercise: draw a box plot"}
...
## {#boxplot-draw data-menu-title="Exercise: draw a box plot"}
...
#| out-width: "100%"
#| fig-align: "center"
five_num <- data.frame(xmin = 2, xlower = 5, xmiddle = 10, xupper = 15, xmax = 16)
points <- data.frame(x = c(2, 4, 6, 8, 10, 12, 14, 16, 40), y = "")

ggplot(five_num, aes(y = "")) +
  geom_boxplot(
    aes(xmin = xmin, xlower = xlower, xmiddle = xmiddle, xupper = xupper, xmax = xmax),
...
## {#numerical-summaries-title data-menu-title="Summation Notation" background-color="#003660"}

<div class="page-center">
<div class="custom-subtitle">Summarizing data numerically</div>
</div>
...
## {#mode data-menu-title="Mode"}

[Mode]{.slide-title}

<hr>

[The most frequently occurring value(s) in a dataset. E.g. $mode\;of\;3, 7, 7, 17 = 7$]{.body-text-m}
...
## {#variance-blank data-menu-title="Variance"} 
...
[**Variance:** measures the mathematical dispersion of data relative to the mean]{.body-text-m}
...
## {#calc-variance-blank data-menu-title="Calculate variance 1"} 

[Exercise]{.slide-title}

<hr>

:::{style="color:green;" .body-text-m}
...
[Calculate variance by hand]{.slide-title}
...
## {#stdev-interpret data-menu-title="Standard deviation"}
...
## {#confidence-intervals-title data-menu-title="Summation Notation" background-color="#003660"}

<div class="page-center">
<div class="custom-subtitle">Confidence intervals</div>
</div>

<!-- TODO: population, sample, statistic, all that needs to be included before talking about confidence interval -->
---
...
- <span style="color:#006699"><b>📊 Data visualization (histograms, box plots, scatterplots)</b></span>
- <span style="color:#D6001C"><b>📐 Quartiles & the interquartile range</b></span>
- <span style="color:#003366"><b>📈 Central tendency (mean & median)</b></span>
:::
...
- <span style="color:#660099"><b>💬 Communicating data summaries responsibly</b></span>
:::
