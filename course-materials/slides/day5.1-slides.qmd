...
## {#bessels-correction data-menu-title="Inference"}

[Bessel's correction for variance ]{.slide-title}

<hr>

![Screenshot from [DataMListic](https://www.youtube.com/watch?v=E3_408q1mjo) video](images/variance.png)
...
:::{.body-text-m} 
- **We want**: the population's true parameter
- **We have**: an estimate calculated from a sample

::: {.teal-text .center-text}
How can communicate how certain we are about that estimate?
:::
...
e
The sum of all values for the PMF must be 1:
$$\sum_x P(X=x) = 1$$
...
## {#pmf-interpret-solution data-menu-title="Exercise: your 212 survey"}
...
:::{.center-text}
![](images/meds-typing-speed-2026.png){width=60%}
:::
...
- <span style="color:#333300"><b>📝 Practice all calculus topics</b></span>
- <span style="color:#330033"><b>🌊 A bit of ODEs</b></span>
