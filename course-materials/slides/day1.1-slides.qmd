...
## {#units data-menu-title="Units" background-color="#003660"}
...
:::{.center-text}
![](/course-materials/slides/images/cuyama.jpeg){width="50%"}
:::
...
6 \text{ in} &= 6 \text{ in} \frac{2.54 \text{ cm}}{1 \text{ in}}\\
&= 6 \frac{2.54}{1} \text{ in}\frac{\text{ cm}}{\text{ in}} \\
...
[Let's take a break!]{.slide-title}
