...
(c) Choose short notation (a letter or symbol) and units for each variable. Using your notation, write the function notation set-up for this relationship (you do not need an explicit formula).
(d) Suppose a simplified model turns out to be:
$$
